    ...
    <div class="col-lg-6">
      ...
      <h3>Daftar Mahasiswa</h3>
        ...
        <ul class="list-group">
          ...
          <a href="<?= BASEURL;?>/mahasiswa/detail/<?= $mhs["id"]; ?>" class="badge text-bg-primary rounded text-decoration-none text-end float-end ms-1" data-bs-toggle="modal" data-bs-target="#forModal">ubah</a>
